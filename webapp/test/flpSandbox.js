		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#student00comsaptrainingfullscreenappfullscreenapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student00comsaptrainingfullscreenappfullscreenapp-display": {
								"semanticObject": "student00comsaptrainingfullscreenappfullscreenapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apps.dflc.fullscreenapp",
									"url": sap.ui.require.toUrl("apps/dflc/fullscreenapp")
								}
							}
						}
					}
